        ...
        <div class="container"><h4>GG Hotel</h4>
            <nav class="nav">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                       <a href="afterloginabout.html" class="nav-link">About</a>
                   </li>

                   <li class="nav-item">
                       <a href="afterlogincontact.html" class="nav-link">Contact</a>
                   </li>
                   ...
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                       <a href="UserBookingView.php" class="nav-link">Booking</a>
                   </li>
        ...
        <section class="hotel">
            <div class="container">
                <h5 class="section-head">
                    <a href='viewAllRoomafterlogin.php' class='button' >View all
